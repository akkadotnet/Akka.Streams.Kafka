...
namespace Akka.Streams.Kafka.Settings
{
    ...
    public static class Subscriptions
    {
        ...
        public static IManualSubscription AssignmentWithOffset((TopicPartition, long) topicPartitions) =>
            new AssignmentWithOffset(ImmutableDictionary<TopicPartition, long>.Empty.Add(topicPartitions.Item1, topicPartitions.Item2));
    }
}
