// -----------------------------------------------------------------------
//  <copyright file="ConnectionCheckerSettings.cs" company="Akka.NET Project">
...
public sealed record ConnectionCheckerSettings
{
    ...
    public static readonly ConnectionCheckerSettings Disabled = new(false, 3, TimeSpan.FromSeconds(15), 2.0);

    public static ConnectionCheckerSettings Create(int maxRetries, TimeSpan checkInterval, double factor) =>
        new(true, maxRetries, checkInterval, factor);
    ...
    public override string ToString() =>
        $"Akka.Streams.Kafka.ConnectionCheckerSettings(Enabled={Enabled},MaxRetries={MaxRetries},CheckInterval={CheckInterval},Factor={Factor})";
}