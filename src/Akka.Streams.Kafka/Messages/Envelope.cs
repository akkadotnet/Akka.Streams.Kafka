// -----------------------------------------------------------------------
//  <copyright file="Envelope.cs" company="Akka.NET Project">
...
public static class ProducerMessage
{
    ...
    /// </summary>
    public static IEnvelope<K, V, TPassThrough> Single<K, V, TPassThrough>(ProducerRecord<K, V> record,
    ...
    /// </summary>
    public static IEnvelope<K, V, TPassThrough> Multi<K, V, TPassThrough>(IImmutableSet<ProducerRecord<K, V>> records,
        TPassThrough passThrough)
...
public sealed class Message<K, V, TPassThrough> : IEnvelope<K, V, TPassThrough>
{
    ...
    public IEnvelope<K, V, TPassThrough2> WithPassThrough<TPassThrough2>(TPassThrough2 value) =>
        new Message<K, V, TPassThrough2>(Record, value);
}
...
public sealed class MultiMessage<K, V, TPassThrough> : IEnvelope<K, V, TPassThrough>
{
    ...
    /// <inheritdoc />
    public IEnvelope<K, V, TPassThrough2> WithPassThrough<TPassThrough2>(TPassThrough2 value) =>
        new MultiMessage<K, V, TPassThrough2>(Records, value);
}
...
public sealed class PassThroughMessage<K, V, TPassThrough> : IEnvelope<K, V, TPassThrough>
{
    ...
    /// <inheritdoc />
    public IEnvelope<K, V, TPassThrough2> WithPassThrough<TPassThrough2>(TPassThrough2 value) =>
        new PassThroughMessage<K, V, TPassThrough2>(value);
}
...
public sealed class Result<K, V, TPassThrough> : IResults<K, V, TPassThrough>
{
    ...
    /// <inheritdoc />
    public TPassThrough PassThrough
    {
        get { return Message.PassThrough; }
    }
