// -----------------------------------------------------------------------
//  <copyright file="Committer.cs" company="Akka.NET Project">
...
public static class Committer
{
    ...
    public static Flow<ICommittable, ICommittableOffsetBatch, NotUsed> BatchFlow(CommitterSettings settings) =>
        Akka.Streams.Dsl.Flow.FromGraph(new CommitCollectorStage(settings))
    ...
    public static Flow<ICommittable, Done, NotUsed> Flow(CommitterSettings settings) =>
        BatchFlow(settings).Select(_ => Done.Instance);
    ...
    /// </summary>
    [ApiMayChange]
    public static FlowWithContext<E, ICommittableOffset, NotUsed, ICommittableOffsetBatch, NotUsed>
        FlowWithOffsetContext<E>(CommitterSettings settings)
    {
    ...
    public static Sink<ICommittable, Task<Done>> Sink(CommitterSettings settings) =>
        Flow(settings).ToMaterialized(Streams.Dsl.Sink.Ignore<Done>(), Keep.Right);
    ...
    public static Sink<(E, ICommittableOffset), Task<Done>> SinkWithOffsetContext<E>(CommitterSettings settings) =>
        Akka.Streams.Dsl.Flow.Create<(E, ICommittableOffset)>()
