// -----------------------------------------------------------------------
//  <copyright file="PromiseControl.cs" company="Akka.NET Project">
...
internal class PromiseControl<TSourceOut> : IControl
{
    ...
    {
        get { return _shutdownTaskSource.Task; }
    }
    ...
    /// </summary>
    protected virtual void PerformShutdown() => _performShutdown();

    /// <summary>
    /// Executed on source logic stop
    /// </summary>
    public void OnStop() => _stopTaskSource.TrySetResult(Done.Instance);
