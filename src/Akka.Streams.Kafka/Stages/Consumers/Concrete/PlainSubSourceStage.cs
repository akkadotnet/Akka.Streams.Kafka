// -----------------------------------------------------------------------
//  <copyright file="PlainSubSourceStage.cs" company="Akka.NET Project">
...
public class PlainSubSourceStage<K, V> : KafkaSourceStage<K, V, (TopicPartition, Source<ConsumeResult<K, V>, NotUsed>)>
{
    ...
    /// </summary>
    public Option<Func<IImmutableSet<TopicPartition>, Task<IImmutableSet<TopicPartitionOffset>>>> GetOffsetsOnAssign
    {
        get;
    }
    ...
    protected override (GraphStageLogic, IControl) Logic(
        SourceShape<(TopicPartition, Source<ConsumeResult<K, V>, NotUsed>)> shape,
