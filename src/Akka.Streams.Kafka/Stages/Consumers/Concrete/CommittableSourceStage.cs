// -----------------------------------------------------------------------
//  <copyright file="CommittableSourceStage.cs" company="Akka.NET Project">
...
internal class CommittableSourceStage<K, V> : KafkaSourceStage<K, V, CommittableMessage<K, V>>
{
    ...
    {
        var logic = new SingleSourceStageLogic<K, V, CommittableMessage<K, V>>(shape, Settings, Subscription,
            inheritedAttributes, GetMessageBuilder);
