// -----------------------------------------------------------------------
//  <copyright file="KafkaSourceStage.cs" company="Akka.NET Project">
...
public abstract class
    KafkaSourceStage<K, V, TMessage> : GraphStageWithMaterializedValue<SourceShape<TMessage>, IControl>
{
    /// <summary>
    /// Name of the stage
    /// </summary>
    ...
    /// Stage out port
    /// </summary>
    public Outlet<TMessage> Out { get; } = new("out");
