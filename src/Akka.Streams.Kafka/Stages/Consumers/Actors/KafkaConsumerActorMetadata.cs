...
namespace Akka.Streams.Kafka.Stages.Consumers.Actors
{
    ...
    public class KafkaConsumerActorMetadata
    {
        ...
        {
            public class ConsumerGroupMetadataRequest
            {
                private ConsumerGroupMetadataRequest() { }
                public static readonly ConsumerGroupMetadataRequest Instance = new ConsumerGroupMetadataRequest();
            }
            
            /// <summary>
            /// Consumer group metadata generated by <see cref="IConsumer{TKey,TValue}"/>
            /// </summary>
            public class ConsumerGroupMetadata
            {
                public ConsumerGroupMetadata(IConsumerGroupMetadata metadata)
                {
                    Metadata = metadata;
                }
                ...
                /// Metadata
                /// </summary>
                public IConsumerGroupMetadata Metadata { get; }
            }
            ...
            public class Messages<K, V>
            {
                ...
                public Messages(
                    int requestId, 
                    ImmutableList<ConsumeResult<K, V>> messagesList)
                {
                    RequestId = requestId;
