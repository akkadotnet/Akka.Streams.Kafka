// -----------------------------------------------------------------------
//  <copyright file="TestsConfiguration.cs" company="Akka.NET Project">
...
public static class TestsConfiguration
{
    ...
    /// </summary>
    public static readonly bool UseFileLogging =
        Environment.GetEnvironmentVariable("AKKA_STREAMS_KAFKA_TEST_FILE_LOGGING") != null;
    ...
    /// </remarks>
    public static readonly bool UseExistingDockerContainer =
        Environment.GetEnvironmentVariable("AKKA_STREAMS_KAFKA_TEST_CONTAINER_REUSE") != null;
}