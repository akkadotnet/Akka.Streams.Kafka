// -----------------------------------------------------------------------
//  <copyright file="MockConsumer.cs" company="Akka.NET Project">
...
public class MockConsumer<TKey, TValue>
{
    ...
    private readonly List<ConsumeResult<TKey, TValue>> _responses = new();
    ...
    private readonly Dictionary<TopicPartition, bool> _paused = new();
    private AtomicBoolean _releaseCommitCallbacks = new();
