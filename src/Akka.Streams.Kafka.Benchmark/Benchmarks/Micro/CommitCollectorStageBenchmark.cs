// -----------------------------------------------------------------------
//  <copyright file="CommitCollectorStageBenchmark.cs" company="Akka.NET Project">
...
public class CommitCollectorStageBenchmark
{
    ...
    [Params(1, 4, 16)] public int PartitionCount { get; set; }

    [Params(10, 100, 1000)] public int BatchSize { get; set; }

    [Params(100)] public int MaxIntervalMs { get; set; }
