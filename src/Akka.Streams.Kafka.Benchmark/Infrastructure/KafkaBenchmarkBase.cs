// -----------------------------------------------------------------------
//  <copyright file="KafkaBenchmarkBase.cs" company="Akka.NET Project">
...
public abstract class KafkaBenchmarkBase
{
    ...
    {
        get { return $"benchmark-topic-{BenchmarkRunId}"; }
    }
    ...
    protected virtual int PartitionCount
    {
        get { return 3; }
    }
    ...
    /// </summary>
    protected virtual TimeSpan CompletionTimeout
    {
    ...
    /// </summary>
    protected void StartDemand() => DemandControl?.TrySetResult(Done.Instance);
}